...
class AssetCreate(Schema):
    ...
    type = fields.String(required=True, validate=validate.Length(max=20))
    market = fields.String(required=True, validate=validate.Length(max=50))
...
class AssetUpdate(Schema):
    ...
    type = fields.String(validate=validate.Length(max=20))
...
class AssetResponse(Schema):
    ...
    class Meta:
        fields = ["id", "code", "name", "type", "market", "industry", "created_at", "updated_at"]